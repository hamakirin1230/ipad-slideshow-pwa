      ...
      <CardContent className="space-y-4">
        <dl className="grid gap-2 text-sm sm:grid-cols-3">
          ...
          <div>
            ...
            <dd className="font-semibold">
              {formatTargetAlias(props.selectedProjectTitle)}
            </dd>
          </div>
        </dl>
...
function formatTargetAlias(projectTitle: string | null) {
  if (canArmPublicationAcceptanceFault("A", projectTitle)) {
    return "case-a-response-unknown";
  }
  if (canArmPublicationAcceptanceFault("C", projectTitle)) {
    return "case-c-index-warning";
  }
  return "対象外";
}
